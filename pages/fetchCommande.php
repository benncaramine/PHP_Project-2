...
<style>
        ...
        $result=$bdd->query("SELECT * FROM `commende`  ");
        ...
        while ($row = $result->fetch(PDO::FETCH_NUM)) {     
            ...
            $x=$bdd->query("SELECT nom FROM client where id = '".$row[0]."';");
            $q=$x->fetch(PDO::FETCH_NUM);
            echo "<td>".$q[0]."</td> ";
            $x1=$bdd->query("SELECT libelle FROM produit where ref = '".$row[1]."';");
            $q1=$x1->fetch(PDO::FETCH_NUM);
            echo "<td>".$q1[0]."</td> ";
            echo "<td>".$row[2]."</td> ";
            echo "<td>".$row[3]."</td> ";

           
            echo "<td><a href=","deletecommande.php?idc=".$row[4].""," id=","delete",">delete</a></td>";            
            echo    "</tr>";
...
?>
    <a href="ajouterCommande.php" id="ajouter">ADD</a>
        </center>
    </body>
</html>