...
<style>
        ...
        while ($row = $result->fetch(PDO::FETCH_NUM)) {     
            ...
            echo "<td>".$row[3]."</td> ";
            echo "<td>".$row[4]."</td> ";
            $x=$bdd->query("SELECT intitule FROM categorie where id = ".$row[6].";");
            $q=$x->fetch(PDO::FETCH_NUM);
            echo "<td>".$q[0]."</td> ";
            echo "<td><a href=","deleteproduct.php?ref=".$row[0].""," id=","delete",">delete</a></td>";
            echo "<td><a href=","modifyProduit.php?ref=".$row[0].""," id=","modify",">modify</a></td>";
            echo    "</tr>";
...
?>
    <a href="insertProduit.php" id="Ajouter">ADD</a>
        </center>
    </body>
</html>