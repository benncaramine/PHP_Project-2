<?php 
    ...
    if(isset($_POST['valider'])){
        ...
        $result=$bdd->query("UPDATE `projet_web`.`categorie` SET `intitule` = '".$nomCat."' WHERE `categorie`.`id` = ".$ref.";");
...
<style>
    ...
    <body>
        <center>
        <div class="back"><a href="fetchcat.php">Retour</a></div>
    <form action="" method="post">
        
    <h6>Nom De Catégorie:</h6><br><input type="text" name="nomCat"><br>
