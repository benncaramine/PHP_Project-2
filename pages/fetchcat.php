...
<style>
        ...
        while ($row = $result->fetch(PDO::FETCH_NUM)) {     
            ...
            echo "<td><a href=","deletecategorie.php?ref=".$row[0].""," id=","delete",">delete</a></td>";
            echo "<td><a href=","modifycategorie.php?ref=".$row[0].""," id=","modify",">modify</a></td>";
            echo    "</tr>";
...
?>
    <a href="insertCategorie.php" id="ajouter">ADD</a>
