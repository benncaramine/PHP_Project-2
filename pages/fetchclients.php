...
<style>
        ...
        while ($row = $result->fetch(PDO::FETCH_NUM)) {     
            ...
            echo "<td><a href=","deleteClient.php?ref=".$row[0].""," id=","delete"," >delete</a></td>";
            echo "<td><a href=","modifyclients.php?ref=".$row[0].""," id=","modify",">modify</a></td>";
            echo    "</tr>";
...
?>
    <a href="insertClient.php" id="ajouter">ADD</a>
            </center>
        </body>
</html>